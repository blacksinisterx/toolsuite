...
import { trimVideo } from '../../processors/ffmpeg'
import { TOOLS } from '../../lib/registry'

const tool = TOOLS.find((t) => t.id === 'video-trim')!
...
export default function VideoTrim() {
  ...
  async function process() {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : 'Could not trim this video.')
    } finally {
      setBusy(false)
    }
  }
