...
export const TOOLS: ToolMeta[] = [
  ...
  { id: 'pdf-add-text', name: 'PDF Annotator', description: 'Add text, highlights and rectangles anywhere on any page -- as many as you like, one download.', category: 'pdf', path: '/pdf/add-text', keywords: ['add', 'text', 'edit', 'pdf', 'annotate', 'highlight', 'annotator'], processing: 'client' },
  ...
  { id: 'color-palette-generator', name: 'Color Palette Generator', description: 'Generate a palette from a base color (6 schemes) or pull the dominant colors out of a photo.', category: 'utilities', path: '/utilities/color-palette-generator', keywords: ['color', 'palette', 'generator', 'scheme', 'complementary', 'analogous', 'tetradic', 'image', 'extract', 'dominant colors'], processing: 'client' },
